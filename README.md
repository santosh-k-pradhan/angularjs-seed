...
We also use a number of Node.js tools to initialize and test `angularjs starter project`. You must have Node.js(> version6) and its package manager (npm) installed. You can get them from [here][node].
